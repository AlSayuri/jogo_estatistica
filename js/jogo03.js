var pontuacao_final;
var mensagem_pontuacao;

function jogo03(){
  var pontos_jogo_03 = 0;
  ...
  var Stage = /** @class */ (function () {
      ...
      Stage.prototype.onResize = function () {
          var viewSize = 30;
          this.renderer.setSize(window.innerWidth, window.innerHeight);
          this.camera.left = (window.innerWidth / -viewSize) + 20;
          this.camera.right = window.innerWidth / viewSize;
          this.camera.top = window.innerHeight / viewSize;
          this.camera.bottom = (window.innerHeight / -viewSize) - 15;
  ...
  var Game = /** @class */ (function () {
      ...
      Game.prototype.addBlock = function () {
          ...
          $("#score_jogo_03").text(this.scoreContainer.innerHTML); // numero acerto
