...
const quizdata=[
      ...
      {
        question:"No município de Porto Barreiro-PR, há uma população total de 3454 pessoas, e 1639 são mulheres. Supondo que 3/5 dos homens não possuem carro, qual a probabilidade de um homem ser escolhido aleatoriamente ter um carro apenas entre a população masculina?",
        options:["A) 35,80%.",
                "B) 45,34%.",
                "C) 40%.",
                "D) 30%."],
